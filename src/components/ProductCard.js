    ...
    return (
        ...
        >
            ...
            <div className='flex gap-2 mt-5'>
                ...
                {productType === 'cart' &&
                    <>
                        <button className='bg-indigo-500 rounded-full py-1 px-2 flex-1 text-white text-bold' onClick={() => dispatch({ type: actionTypes.REMOVE_FROM_CART, payload: product._id })}>
                            Remove from cart
                        </button>
                        <button
                            title='Add to wishlist'
